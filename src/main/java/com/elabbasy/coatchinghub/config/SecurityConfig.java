...
import com.elabbasy.coatchinghub.security.JwtAuthenticationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/**",
                                ...
                                "/mobile/api/coaches/register/**",
                                "/mobile/api/coaches/search",
                                "/uploads/**",
                                "/mobile/api/lookup/**",
                        ...
                        .requestMatchers("/portal/**").hasRole("ADMIN")
